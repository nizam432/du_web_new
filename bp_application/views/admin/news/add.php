<div class="breadcrumb_container">
    <div class="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li><a class="active">Add New News</a></li>
        </ol>
    </div>
</div>
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="box-body">
                ...
                <?php } ?>
                <form id="hsc_add_form"  action="<?php echo base_url(); ?>backend_news/save" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">				
                        ...
                        <div class="col-sm-8">
                            <textarea id="editor1" name="details" class="form-control"></textarea>
                        </div>
                    </div>  				
                    <div class="form-group">				
