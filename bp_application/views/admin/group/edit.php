...
<div class="col-md-12">
  <!-- general form elements -->
	<div class="box box-primary">
		...
		<!-- /.box-header -->
		<!-- form start -->
		<form action="<?php echo base_url(); ?>backend_group/update/<?php echo $group_edit->group_id ?>" method="post">
		<!-- form start -->
			<div class="box-body">
				<?php 
				...
				<div class="form-group ">
					...
					<div class="col-sm-4">
						<input type="text" name="group_name" value="<?php echo $group_edit->group_name; ?>" class="form-control">
					</div>					
					<label class="col-sm-2">Isactive</label>
					<div class="col-sm-4">
						<select name="isactive" class="form-control">
							<option <?php if($group_edit->isactive==1) echo '" selected="selected"'?>  value="1">Active</option>
							<option <?php if($group_edit->isactive==2) echo '" selected="selected"'?>  value="2">Inactive</option>
						</select>
					</div>
				</div>
