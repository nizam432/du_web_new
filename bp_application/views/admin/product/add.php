    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="box-body">
                ...
                <?php } ?>
                <form id="hsc_add_form"  action="<?php echo base_url(); ?>backend_product/save" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select name="group_id"  class="form-control group_id">	
                                ...
                                <?php
                                    foreach ($product_group as $group_data) {
                                        echo '<option  value="' . $group_data->group_id . '">' .$group_data->group_name . '</option>';
                                    }
                                ?>
                            </select>								
                        </div>						
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea type="text" name="description" id="description"  class="form-control input-sm textarea" /> </textarea>
                        </div>
                    </div>         
                    <div class="form-group">
